    ...
    def transform_query(
        ...
        try:
            ...
            transformation_prompt = (
                ...
                "not specific dates\n"
                "- **CRITICAL**: For date queries, ALWAYS include technical "
                "keywords (CUDA, GPU, AI, machine learning, TensorRT, deep learning, "
                "neural networks, inference, training, etc.)\n"
                ...
                f"CUDA, and deep learning developments from {current_month_year}'\n"
                f"- Example: 'Recent developments' → 'Latest NVIDIA GPU technology, "
                f"AI frameworks, and CUDA programming updates from {current_month_year}'\n"
                f"- Example: 'Latest articles' → 'Most recent NVIDIA blog posts about "
                f"GPU computing, AI, machine learning, and developer tools from "
                f"{current_month_year}'\n"
                f"- Example: 'Blogs from December 11, 2025' → "
                f"'NVIDIA GPU computing, AI, CUDA, TensorRT, machine learning, and "
                f"deep learning blog posts from December 2025'\n"
                f"- Example: 'December 2025 blogs' → 'NVIDIA technology developments "
                f"in GPU computing, AI, CUDA programming, and neural networks from "
                f"December 2025'\n\n"
                f"ORIGINAL QUERY:\n{original_query}\n\n"
