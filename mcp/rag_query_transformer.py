    ...
    def transform_query(
        ...
        try:
            ...
            transformation_prompt = (
                ...
                f"- Example: 'Recent developments' → 'Latest NVIDIA "
                f"developments from {current_month_year}'\n"
                f"- Example: 'Latest articles' → 'Most recent NVIDIA "
                f"articles from {current_month_year}'\n\n"
                f"ORIGINAL QUERY:\n{original_query}\n\n"
